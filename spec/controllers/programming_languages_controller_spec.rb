...
RSpec.describe ProgrammingLanguagesController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      ProgrammingLanguage.create! valid_attributes
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: programming_language.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      programming_language = ProgrammingLanguage.create! valid_attributes
      get :edit, params: {id: programming_language.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ProgrammingLanguage" do
        expect {
          post :create, params: {programming_language: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {programming_language: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested programming_language" do
        programming_language = ProgrammingLanguage.create! valid_attributes
        put :update, params: {id: programming_language.to_param, programming_language: new_attributes}, session: valid_session
      ...
      it "redirects to the programming_language" do
        programming_language = ProgrammingLanguage.create! valid_attributes
        put :update, params: {id: programming_language.to_param, programming_language: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        programming_language = ProgrammingLanguage.create! valid_attributes
        put :update, params: {id: programming_language.to_param, programming_language: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested programming_language" do
      programming_language = ProgrammingLanguage.create! valid_attributes
      expect {
        delete :destroy, params: {id: programming_language.to_param}, session: valid_session
      }.to change(ProgrammingLanguage, :count).by(-1)
    end
